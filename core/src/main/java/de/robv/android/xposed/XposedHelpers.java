...
public final class XposedHelpers {
     ...
     *
     * <p>Android 17 rejects every reflective write to a static final field, whatever the Field's
     ...
     * are still reflection's.</p>
     *
     * <p>Only reached once reflection has thrown, so nothing changes on the releases that allow the
     * write, and a genuine access failure — or a runtime this cannot read — still ends in the
     * IllegalAccessError it always did.</p>
     */
