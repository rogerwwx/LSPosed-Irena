...
namespace lspd::native::jni {
    ...
    static std::string GetXResourcesClassName() {
        ...
        static auto name = lspd::native::JavaNameToSignature(
    ...
    LSPD_DEF_NATIVE_METHOD(jboolean, ResourcesHook, initXResourcesNative) {
    ...
    LSPD_DEF_NATIVE_METHOD(jboolean, ResourcesHook, makeInheritable, jclass target_class) {
    ...
    LSPD_DEF_NATIVE_METHOD(jobject, ResourcesHook, buildDummyClassLoader, jobject parent,
    ...
    LSPD_DEF_NATIVE_METHOD(void, ResourcesHook, rewriteXmlReferencesNative,
    ...
    static JNINativeMethod gMethods[] = {
            LSPD_NATIVE_METHOD(ResourcesHook, initXResourcesNative, "()Z"),
            LSPD_NATIVE_METHOD(ResourcesHook, makeInheritable,"(Ljava/lang/Class;)Z"),
            LSPD_NATIVE_METHOD(ResourcesHook, buildDummyClassLoader,
                              "(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/ClassLoader;"),
            LSPD_NATIVE_METHOD(ResourcesHook, rewriteXmlReferencesNative,
                              "(JLandroid/content/res/XResources;Landroid/content/res/Resources;)V")
    };

    void RegisterResourcesHook(JNIEnv *env) {
        // XResources itself is obfuscated by the daemon, so the descriptor of
        // rewriteXmlReferencesNative has to be rebuilt with the runtime class name.
        static const std::string sign =
                fmt::format("(JL{};Landroid/content/res/Resources;)V", GetXResourcesClassName());
        gMethods[3].signature = sign.c_str();

        REGISTER_LSPD_NATIVE_METHODS(ResourcesHook);
    }
}
