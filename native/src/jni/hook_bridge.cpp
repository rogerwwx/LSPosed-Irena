...
#define LSPD_DISPATCH(Kind, member)                                                          \
    ...
    switch (return_type) {
        case 'I':
            ...
            break;
        case 'D':
            LSPD_DISPATCH(Double, d);
            break;
        case 'J':
            LSPD_DISPATCH(Long, j);
            break;
        case 'F':
            LSPD_DISPATCH(Float, f);
            break;
        case 'S':
            LSPD_DISPATCH(Short, s);
            break;
        case 'B':
            LSPD_DISPATCH(Byte, b);
            break;
        case 'C':
            LSPD_DISPATCH(Char, c);
            break;
        case 'Z':
            LSPD_DISPATCH(Boolean, z);
            break;
        case 'L': {
            LSPD_DISPATCH(Object, l);
            auto value = result.l;
...
LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, hookMethod, jobject hookMethod, jclass hooker,
...
LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, unhookMethod, jobject hookMethod, jobject callback) {
    auto target = env->FromReflectedMethod(hookMethod);
    HookItem * hook_item = nullptr;
    hooked_methods.if_contains(target, [&hook_item](const auto &it) {
        hook_item = it.second.get();
 ...
 */
LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, replaceCallback, jobject hookMethod,
 ...
 */
LSPD_DEF_NATIVE_METHOD(jobjectArray, HookBridge, legacyApiPrefixes) {
...
LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, deoptimizeMethod, jobject hookMethod) {
    return lsplant::Deoptimize(env, hookMethod);
}

LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, invokeOriginalMethod, jobject hookMethod,
...
LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, invokeExecutable, jobject executable,
                      jobject thiz, jobjectArray args, jboolean nonVirtual) {
    return InvokeExecutable(env, executable, thiz, args, nonVirtual);
}

LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, findClassInitializer, jclass cls) {
...
LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, allocateObject, jclass cls) {
    return AllocateReceiver(env, cls).release();
}

LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, allocateSpecialReceiver, jobject constructor, jclass cls) {
    auto &cache = GetInvokeCache(env);
    return AllocateSpecialReceiver(env, cache, constructor, cls).release();
}

LSPD_DEF_NATIVE_METHOD(jobject, HookBridge, invokeSpecialMethod, jobject method, jclass cls,
                      jobject thiz, jobjectArray args) {
    return InvokeSpecial(env, method, cls, thiz, args);
}

LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, instanceOf, jobject object, jclass expected_class) {
    return env->IsInstanceOf(object, expected_class);
}

LSPD_DEF_NATIVE_METHOD(jint, HookBridge, gettid) {
    return gettid();
}

LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, setTrusted, jobject cookie) {
 ...
 */
LSPD_DEF_NATIVE_METHOD(jboolean, HookBridge, makeFieldWritable, jobject field, jint modifiers) {
...
LSPD_DEF_NATIVE_METHOD(jobjectArray, HookBridge, callbackSnapshot, jobject method, jint maxPriority) {
    auto target = env->FromReflectedMethod(method);
...
static JNINativeMethod gMethods[] = {
    LSPD_NATIVE_METHOD(HookBridge, hookMethod, "(Ljava/lang/reflect/Executable;Ljava/lang/Class;ILjava/lang/Object;)Z"),
    LSPD_NATIVE_METHOD(HookBridge, unhookMethod, "(Ljava/lang/reflect/Executable;Ljava/lang/Object;)Z"),
    LSPD_NATIVE_METHOD(HookBridge, replaceCallback, "(Ljava/lang/reflect/Executable;Ljava/lang/Object;Ljava/lang/Object;I)Z"),
    LSPD_NATIVE_METHOD(HookBridge, legacyApiPrefixes, "()[Ljava/lang/String;"),
    LSPD_NATIVE_METHOD(HookBridge, deoptimizeMethod, "(Ljava/lang/reflect/Executable;)Z"),
    LSPD_NATIVE_METHOD(HookBridge, invokeOriginalMethod,
                      "(Ljava/lang/reflect/Executable;Ljava/lang/Object;[Ljava/lang/Object;Z)Ljava/lang/Object;"),
    LSPD_NATIVE_METHOD(HookBridge, invokeExecutable,
                      "(Ljava/lang/reflect/Executable;Ljava/lang/Object;[Ljava/lang/Object;Z)Ljava/lang/Object;"),
    LSPD_NATIVE_METHOD(
            HookBridge, invokeSpecialMethod,
            "(Ljava/lang/reflect/Executable;Ljava/lang/Class;"
            "Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;"),
    LSPD_NATIVE_METHOD(HookBridge, allocateObject, "(Ljava/lang/Class;)Ljava/lang/Object;"),
    LSPD_NATIVE_METHOD(HookBridge, allocateSpecialReceiver,
                      "(Ljava/lang/reflect/Constructor;Ljava/lang/Class;)Ljava/lang/Object;"),
    LSPD_NATIVE_METHOD(HookBridge, findClassInitializer, "(Ljava/lang/Class;)Ljava/lang/reflect/Method;"),
    LSPD_NATIVE_METHOD(HookBridge, instanceOf, "(Ljava/lang/Object;Ljava/lang/Class;)Z"),
    LSPD_NATIVE_METHOD(HookBridge, gettid, "()I"),
    LSPD_NATIVE_METHOD(HookBridge, setTrusted, "(Ljava/lang/Object;)Z"),
    LSPD_NATIVE_METHOD(HookBridge, makeFieldWritable, "(Ljava/lang/reflect/Field;I)Z"),
    LSPD_NATIVE_METHOD(HookBridge, callbackSnapshot, "(Ljava/lang/reflect/Executable;I)[Ljava/lang/Object;"),
};

void RegisterHookBridge(JNIEnv *env) {
    REGISTER_LSPD_NATIVE_METHODS(HookBridge);
}
}  // namespace lspd::native::jni
