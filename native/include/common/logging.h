...
#ifndef NDEBUG
#define LOGV(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_VERBOSE, LOG_TAG, "{}:{} ({}): " fmt,       \
                                           __FILE_NAME__, __LINE__,                                \
                                           __PRETTY_FUNCTION__ __VA_OPT__(, ) __VA_ARGS__)
#define LOGD(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_DEBUG, LOG_TAG, "{}:{} ({}): " fmt,         \
                                           __FILE_NAME__, __LINE__,                                \
                                           __PRETTY_FUNCTION__ __VA_OPT__(, ) __VA_ARGS__)
#else
#define LOGV(...) ((void)0)
...
#define LOGI(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_INFO, LOG_TAG,                              \
                                           fmt __VA_OPT__(, ) __VA_ARGS__)
#define LOGW(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_WARN, LOG_TAG,                              \
                                           fmt __VA_OPT__(, ) __VA_ARGS__)
#define LOGE(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_ERROR, LOG_TAG,                             \
                                           fmt __VA_OPT__(, ) __VA_ARGS__)
#define LOGF(fmt, ...)                                                                             \
    ::lspd::native::detail::LogToAndroid(ANDROID_LOG_FATAL, LOG_TAG,                             \
                                           fmt __VA_OPT__(, ) __VA_ARGS__)
