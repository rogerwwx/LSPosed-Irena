 ...
 *
 * @return The JNI signature prefix (e.g., "org/lsposed/lspd/nativebridge/").
 */
...
#define LSPD_JNI_CAST(to) reinterpret_cast<to>

/**
 * @def LSPD_NATIVE_METHOD(className, functionName, signature)
 ...
 */
#define LSPD_NATIVE_METHOD(className, functionName, signature)                                   \
    {#functionName, signature,                                                                     \
     LSPD_JNI_CAST(void *)(Java_org_lsposed_lspd_nativebridge_##className##_##functionName)}
...
/**
 * @def LSPD_DEF_NATIVE_METHOD(ret, className, functionName, ...)
 ...
 */
#define LSPD_DEF_NATIVE_METHOD(ret, className, functionName, ...)                                \
    extern "C" JNIEXPORT ret JNICALL                                                               \
        Java_org_lsposed_lspd_nativebridge_##className##_##functionName(JNI_START, ##__VA_ARGS__)

/**
 * @def REGISTER_LSPD_NATIVE_METHODS(class_name)
 ...
 */
#define REGISTER_LSPD_NATIVE_METHODS(class_name)                                                 \
